...
# test_list = [
#     (1, {'название': 'компьютер', 'цена': 20000, 'количество': 5, 'eд': 'шт.'}),
#     (2, {'название': 'принтер', 'цена': 6000, 'количество': 2, 'eд': 'шт.', 'банан': 'да'}),
#     (3, {'название': 'сканер', 'цена': 2000, 'количество': 7, 'eд': 'шт.'})
# ]
...
for element in goods_table:
    ...
    for key in element[1].keys():
        ...
        if key in analytics_dict_total.keys():
            ...
            print(key, ' не добавляли')

print(analytics_dict_total)
