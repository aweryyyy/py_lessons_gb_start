...
class DichException(Exception):
    ...
    def user_input():
        input_data = []
        exit_on = 'q'
        while exit_on not in input_data:
            input_data.append(input('Введите числа: '))
        return input_data


users_data = DichException(DichException.user_input())
# test = DichException.user_input()
